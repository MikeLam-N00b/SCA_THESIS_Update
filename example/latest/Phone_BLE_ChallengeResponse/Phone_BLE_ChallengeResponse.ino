...
// Pairing key - PHẢI GIỐNG với key trong Vehicle
// Key này là key mà Vehicle nhận từ server: "pairing_key"
// Trong thực tế, Phone app cũng sẽ lấy key này từ server sau khi owner pairing
const char* CORRECT_KEY_HEX = "e9b8da4e60206bd04bd554c6a94e4e0e";

// Test với wrong key
const char* WRONG_KEY_HEX = "ffffffffffffffffffffffffffffffff";

// Chọn key để test
bool useCorrectKey = true;  // true = correct key, false = wrong key để test authentication fail
