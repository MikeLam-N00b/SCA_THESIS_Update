...
object KeyManager {
    ...
    private var hceEnabled: Boolean = false
    ...
    fun init(context: Context) {
        ...
        hceEnabled = prefs?.getBoolean("hce_enabled", false) == true
        if (lastVin != null) {
    ...
    fun isHceEnabled(): Boolean = hceEnabled

    fun setHceEnabled(enabled: Boolean) {
        hceEnabled = enabled
        prefs?.edit()?.putBoolean("hce_enabled", enabled)?.apply()
    }
